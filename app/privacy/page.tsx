    ...
    <SiteShell>
      <main>
        ...
        <div className="highlight">
          <p>
            <strong style={{ color: "var(--cyan)" }}>Summary:</strong> Metraly
            is being built as a self-hosted Engineering Intelligence platform.
            This policy explains the website, synthetic demo, communications,
            commercial/support workflows, and the intended boundary for
        ...
        <h2>18. Contact</h2>
        <p>
          Privacy questions: <a href="mailto:privacy@metraly.io">privacy@metraly.io</a>
          <br />
